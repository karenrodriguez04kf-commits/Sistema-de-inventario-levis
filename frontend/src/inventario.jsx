...
function Inventario() {
    ...
    const [form, setForm] = useState({
        ...
        precioProducto: "", 
        stockProducto: "", 
        imagen: null, // Cambiado a null para recibir objeto File
        talla: "", 
        genero: "", 
        color: "", 
        categoria: "pantalon" 
    ...
    const abrirModal = (prod = null) => {
        if (prod) {
            ...
            // Cuando editamos, no cargamos la imagen en el formFile, 
            // solo los textos
    ...
    const guardarProducto = async () => {
        // MUY IMPORTANTE: Usar FormData para enviar archivos
        ...
        // ... agrega el resto de campos de Santiago

        // Agrega la imagen si se seleccionó una nueva
        if (form.imagen) {
        ...
        try {
            // El backend ahora recibe FormData
    ...
    // URL BASE para las imágenes que configuramos en server.js
                ...
                {view === "home" && (
                    <div className="dashboard-home">
                        <div className="welcome-box">
                            <span className="brand-badge-red">ADMIN PANEL</span>
                            <h1>Bienvenido, Mauro</h1>
                            <p>Aquí tienes el estado actual de tu inventario Levi's.</p>
                    ...
                    <div className="modal-card">
                        ...
                        <div className="modal-form-body">
                            <div className="form-group">
                                ...
                                <input type="text" value={form.nombreProducto} onChange={e => setForm({...form, nombreProducto: e.target.value})} placeholder="Ej: Jeans 501 Original" />
                            </div>
                            ...
                            {/* ... el resto de campos (talla, categoría, etc.) ... */}
                            ...
                            <div className="form-group">
                                ...
                                <input 
                                    type="file" 
                                    accept="image/*" 
                                    onChange={(e) => setForm({...form, imagen: e.target.files[0]})} // Mnejo como archivo
                                    id="file-upload"
                                    style={{ display: 'none' }}
                                />
